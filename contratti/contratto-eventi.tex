...
\section*{3. assegnaChef(e: Evento, chef: Chef)}
...
\section*{4. assegnaPersonale(e: Evento, s: Scheda, m: Membro del personale)}
...
\end{itemize}
\textbf{Post-condizione} Se \textit{org} è \textbf{proprietario} di e
\begin{itemize}
...
\subsection*{(2-4)a.1 modificaData(e: Evento, s: Scheda, data: data)}
...
\subsection*{(2-4)b.1 modificaLuogo(e: Evento, s: Scheda, luogo: Testo)}
...
\subsection*{(2-4)c.1 modificaNPartecipanti(e:Evento, s: Scheda, numero\_partecipanti: numero)}
\textbf{Pre-condizione}
\begin{itemize}
  \item è in corso la creazione di un $Evento$ \textbf{e}
\end{itemize} 
...
\subsection*{(3-4)a.1 modificaChef(e: Evento, s: Scheda, c: Chef)}
\textbf{Pre-condizione}
\begin{itemize}
  \item è in corso la creazione di un $Evento$ \textbf{e}
\end{itemize} 
...
\subsection*{4a.1 aggiungiRuoloPersonale(e: Evento, m: \textit{Membro del Personale}, ruolo: Ruolo)}
\textbf{Pre-condizione}
\begin{itemize}
  \item è in corso la creazione di un $Evento$ \textbf{e}
...
\subsection*{4b.1 rimuoviPersonale(e: Evento, m: \textit{Membro del Personale})}
\textbf{Pre-condizione}
\begin{itemize}
  \item è in corso la creazione di un $Evento$ \textbf{e}
  \item m è parte del personale dell'evento
...
\subsection*{4c.1 rimuoviRuoloPersonale(e: Evento, m: \textit{Membro del Personale})}
\textbf{Pre-condizione}
\begin{itemize}
  \item è in corso la creazione di un $Evento$ \textbf{e}
  \item m è parte del personale dell'evento
